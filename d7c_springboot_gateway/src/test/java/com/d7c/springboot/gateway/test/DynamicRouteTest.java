...
public class DynamicRouteTest {
     ...
     * 2、如果事先没有预热，则启动该服务后会向 com.d7c.springboot.gateway.config.GatewayConfiguration.GATEWAY_ROUTES_DIRECT_QUEUE
     * 点对点队列中发送一条消息，其他服务监听到该消息后需将路由规则一条一条发送到 com.d7c.springboot.gateway.config.GatewayConfiguration.GATEWAY_ROUTES_TOPIC_QUEUE
     * 消息队列，所有网关服务都会监听 com.d7c.springboot.gateway.config.GatewayConfiguration.GATEWAY_ROUTES_TOPIC_QUEUE 发布订阅消息队列；
