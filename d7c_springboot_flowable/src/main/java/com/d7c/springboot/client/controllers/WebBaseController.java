package com.d7c.springboot.client.controllers;
...
import com.d7c.plugins.tools.file.FileUtil;
...
public class WebBaseController {
     ...
     * @Description: 设置保存结果
     * @param result        com.d7c.plugins.core.PageResult 对象
     * @param operateInfo   操作信息
     * @return PageResult   com.d7c.plugins.core.PageResult 对象
     */
