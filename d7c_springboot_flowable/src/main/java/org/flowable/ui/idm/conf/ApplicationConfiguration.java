...
@ComponentScan(basePackages = {"org.flowable.ui.common.conf", "org.flowable.ui.idm.conf",
        "org.flowable.ui.idm.security",
        /*"org.flowable.ui.idm.idm",*/ "org.flowable.ui.idm.service"}, excludeFilters = {
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = org.flowable.ui.common.service.idm.RemoteIdmServiceImpl.class)})
public class ApplicationConfiguration {

    @Bean
    public ServletRegistrationBean<DispatcherServlet> apiServlet(ApplicationContext applicationContext) {
