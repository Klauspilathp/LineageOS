...
import com.gnol.springboot.client.services.mq.InputChannel;
import com.gnol.springboot.client.services.mq.OrderLogChannel;
 ...
 * @Description: MQ 消费者实现，生产者参见 /gnol_springboot_client_api/src/main/java/com/gnol/springboot/client/services/test/。
