...
import top.d7c.plugins.tools.code.VerifyCodeUtil;
import top.d7c.plugins.tools.code.captcha.Captcha;
import top.d7c.plugins.tools.code.captcha.GifCaptcha;
import top.d7c.plugins.tools.code.captcha.SpecCaptcha;
import top.d7c.redis.springboot.autoconfigure.RedisService;
 ...
 * @Description: d7c 系统获取验证码 Controller
 */
@Controller
public class VerifyCodeController extends WebBaseController {
    ...
    public void verifyCode(HttpServletResponse response, HttpServletRequest request) {
        ...
        redisService.addString(redisService.generateKey(D7cConstant.SESSION_VERIFY_CODE, request.getSession().getId()),
    ...
    public void gifCode(HttpServletResponse response, HttpServletRequest request) {
        ...
        try {
            ...
            redisService.addString(
                    redisService.generateKey(D7cConstant.SESSION_VERIFY_CODE, request.getSession().getId()), 60,
