...
import top.d7c.springboot.client.config.RedisPersistentTokenRepository;
 ...
 * @Description: d7c 系统菜单表 Controller
 */
@Controller
...
public class SysMenuController extends WebBaseController {
    ...
    public PageResult authMenu() {
        ...
        Object listMenuTree = redisService
                .getObject(redisService.generateKey(D7cConstant.MENULIST, SecurityUtil.getUserId()));
        if (listMenuTree == null) {
            ...
            if (user != null) {
                ...
                redisService.addObject(redisService.generateKey(D7cConstant.MENULIST, userId),
