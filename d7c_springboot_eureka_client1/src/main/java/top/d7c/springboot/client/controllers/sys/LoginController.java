...
import top.d7c.springboot.client.config.ClientResources;
...
public class LoginController extends WebBaseController {
     ...
     * eureka client1 资源属性
     */
    @Resource(name = "d7cEurekaClient1ClientResources")
    private ClientResources d7cEurekaClient1ClientResources;
    /**
     * github 资源属性
     */
    ...
    public String eureka_client1() {
        ...
        return sb.append("redirect:")
                .append(d7cEurekaClient1ClientResources.getCodeResourceDetails().getUserAuthorizationUri())
                .append("?client_id=").append(d7cEurekaClient1ClientResources.getCodeResourceDetails().getClientId())
    ...
    private PageResult eureka_client1(String code) {
        ...
        url.append(d7cEurekaClient1ClientResources.getCodeResourceDetails().getAccessTokenUri()).append("?client_id=")
                .append(d7cEurekaClient1ClientResources.getCodeResourceDetails().getClientId())
                .append("&client_secret=")
                .append(d7cEurekaClient1ClientResources.getCodeResourceDetails().getClientSecret()).append("&code=")
        ...
        // get 请求获取用户信息
        String user_info_url = d7cEurekaClient1ClientResources.getResourceServer().getUserInfoUri() + "?access_token="
                + accessToken;
