package com.d7c.springboot.gateway.fallback;
...
import com.d7c.springboot.gateway.filters.PreAuthFilter;
        ...
        return new ClientHttpResponse() {
            ...
            public InputStream getBody() throws IOException {
                return new ByteArrayInputStream(new ObjectMapper().writeValueAsBytes(
                        PageResult.build(com.d7c.plugins.core.enums.HttpStatus.HS_500.getKey(), "服务不可用，请稍后再试。")));
            }
