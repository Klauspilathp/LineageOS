...
import top.d7c.plugins.tools.date.TimeConstant;
import top.d7c.springboot.common.dos.D7cSession;
 ...
 * @Description: d7c 系统_用户详情权限临时表，用户在登录，下线等情况下触发插入、删除、更新操作，然后以此表关联业务表查询指定范围内的 pojo
 */
public class SysSession extends D7cSession {
