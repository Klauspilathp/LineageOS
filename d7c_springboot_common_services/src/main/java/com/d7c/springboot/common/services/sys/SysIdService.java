package com.d7c.springboot.common.services.sys;
...
public interface SysIdService extends BaseService<SysId, String> {
     ...
     * @Description: 持久化一个 com.d7c.springboot.common.pojos.sys.SysId 对象
     * @param idKey     id 表操作的唯一主键，字符串类型，建议设置成表名
     * @param perNum    每次获取个数
     * @return SysId    从数据库获取到的 com.d7c.springboot.common.pojos.sys.SysId 对象
     */
