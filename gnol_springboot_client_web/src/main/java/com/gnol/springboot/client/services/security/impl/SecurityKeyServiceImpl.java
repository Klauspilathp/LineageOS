package com.gnol.springboot.client.services.security.impl;
...
import com.gnol.springboot.common.daos.security.BaseSecurityKeyDao;
 ...
 * @Description: gnol 系统安全模块_用户或系统密钥 Service 实现
 */
...
public class SecurityKeyServiceImpl extends AbstractBaseService<BaseSecurityKeyDao, SecurityKey, Long>
    ...
    public PageResult insertKey(PageData pd) {
        ...
        if (StringUtil.isBlank(appid)) {
            return PageResult.error("gnol 系统安全模块_用户或系统密钥编号不能为空！");
        }
    ...
    public PageResult updateStatus(PageData pd) {
        ...
        return count == 1 ? PageResult.ok() : PageResult.error("gnol 系统安全模块_用户或系统密钥删除失败！");
    }
