...
public class Test1Controller {
    ...
    /**
     * http://127.0.0.1:8093/test1/t1?id=2 需要关闭 top.d7c.springboot.client.config.RestTemplateConfig.restTemplate() 方法上的 @LoadBalanced 注解
     */
    @RequestMapping("/t1")
    ...
    /**
     * http://127.0.0.1:8093/test1/t2?id=2 需要开启 top.d7c.springboot.client.config.RestTemplateConfig.restTemplate() 方法上的 @LoadBalanced 注解
     */
    @RequestMapping("/t2")
    public Object t2(String id) {
        String url = "http://d7c-springboot-client1/test1/t1?id=" + id;
    ...
    public PageResult t3() {
        ServiceInstance serviceInstance = loadBalancerClient.choose("d7c-springboot-client1");
    ...
    public PageResult t4() {
        InstanceInfo instance = eurekaClient.getNextServerFromEureka("d7c-springboot-client1", false);
