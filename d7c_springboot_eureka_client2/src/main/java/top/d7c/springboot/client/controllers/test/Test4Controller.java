...
public class Test4Controller {
    ...
    /**
     * http://d7c-springboot-client1/test2/t1 请求正常
     * http://d7c-springboot-client1/test2/t2 请求会被降级
     */
    @HystrixCommand(fallbackMethod = "getFallback")
    @RequestMapping(value = "/t1", method = RequestMethod.GET)
    public PageResult t1(String id) {
        logger.info("client2.t1 param id : {}", id);
        return restTemplate.getForObject("http://d7c-springboot-client1/test2/t1?id=" + id, PageResult.class);
    }
