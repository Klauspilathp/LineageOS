...
public class Test1Controller {
    ...
    /**
     * http://127.0.0.1:8093/test1/t1?id=2 需要关闭 com.d7c.springboot.client.config.RestTemplateConfig.restTemplate() 方法上的 @LoadBalanced 注解
     */
    @RequestMapping("/t1")
    ...
    /**
     * http://127.0.0.1:8093/test1/t2?id=2 需要开启 com.d7c.springboot.client.config.RestTemplateConfig.restTemplate() 方法上的 @LoadBalanced 注解
     */
    @RequestMapping("/t2")
