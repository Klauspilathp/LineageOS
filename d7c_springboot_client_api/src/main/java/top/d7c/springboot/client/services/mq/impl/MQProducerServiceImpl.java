...
import top.d7c.springboot.client.services.mq.OutputChannel;
 ...
 * @Description: MQ 消息生产者实现，消费者参见 /d7c_springboot_webflux/src/main/java/top/d7c/springboot/client/services/test/。
