...
public class Oauth2Application {
    ...
    /**
     * jdbc 储存策略认证流程：
     *  1、sys_user 表系统用户通过 com.d7c.springboot.client.config.WebSecurityConfiguration 配置中的 
     *      com.d7c.springboot.client.config.UserDetailsServiceImpl.loadUserByUsername(String) 服务去从库中加载系统用户；
     *  2、oauth_client_details 表客户端通过 com.d7c.springboot.client.config.JdbcAuthorizationServerConfiguration 配置中的 
     ...
     *      `additional_information`, `autoapprove`, `create_time`) VALUES ('client1', 'd7c-springboot-client-api', 
