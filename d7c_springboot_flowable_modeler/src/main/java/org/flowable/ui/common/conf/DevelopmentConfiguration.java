...
public class DevelopmentConfiguration {
    ...
    public DataSource developmentDataSource() {
        return DataSourceBuilder.create()
                .driverClassName(env.getProperty("spring.datasource.driver-class-name", DATASOURCE_DRIVER_CLASS_NAME))
                .url(env.getProperty("spring.datasource.url", DATASOURCE_URL))
                .username(env.getProperty("spring.datasource.username", DATASOURCE_USERNAME))
                .password(env.getProperty("spring.datasource.password", DATASOURCE_PASSWORD)).build();
    }
